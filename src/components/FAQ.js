...
export default function FAQ() {
    ...
    return (
        <div className="lg:p-40 md:p-20 p-8 flex flex-wrap bg-lotion">

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold w-full p-1 md:p-2 lg:p-5">FAQ</h1>

            <div className="p-1 md:p-2 lg:p-5 w-full md:w-1/2">
