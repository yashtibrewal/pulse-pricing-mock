...
export default function Pricing() {
    ...
    return (
        <div className="lg:p-40 md:p-20 p-4 py-2 lg:py-10 md:py-5 flex flex-wrap space-y-10">
            
            <div className="flex flex-col items-center w-full space-y-14">
                <div className="mt-5 text-4xl md:text-5xl lg:text-6xl w-full lg:w-1/2 font-extrabold text-center text-black-rich">
                    Try Pulse free for 30 days.
                </div>
                <div className="w-full lg:w-1/2 text-center text-black-rich">
                    See why Pulse is the best way to monitor your cash flow. Sign up for any plan and try Pulse absolutely free for 30 days.
                </div>
            </div>

            <div className="flex flex-wrap w-full items-center space-y-10 lg:space-y-0 ">
                <div className="w-full lg:w-1/3  lg:p-10 space-y-5">
                    {/* Details */}
                ...
                <div className="pb-5 w-full lg:w-1/3  border-2 border-green-go flex flex-col text-center space-y-5 items-center bg-lotion border-1 rounded-t-lg">
                    {/* Recommended Plan */}
                    ...
                    <div className="text-3xl md:text-4xl lg:text-5xl p-3 md:p-5 lg:p-10 lg:pb-0 font-bold text-green-go">
                        Small Business Plan
                    </div>
                    <div className="text-lg md:text-xl lg:text-2xl text-gray-500">
                        $59 per month
                    </div>
                    <a  className="hover:scale-110 w-fit py-3  font-extrabold md:text-lg lg:text-xl px-10 bg-green-ufo">Sign-up Now</a>
                    <div className="flex flex-col p-2 lg:p-5 text-sm tracking-tight space-y-5 text-gray-600 text-left">
                ...
                <div className="pb-5 h-fit border-2 border-gray-300 flex flex-col text-center space-y-5 items-center w-full lg:w-1/3   bg-lotion">
                    {/* Higher Plan */}
                    <div className="w-full text-sm text-center bg-gray-100 border-b-2 border-gray-300 p-5">Complex business with multiple financial accounts, currencies, or auditing needs?</div>
                    <div className="text-4xl p-3 md:p-5 lg:p-10 lg:pb-0 text-green-go">
            ...
            <div className="flex justify-center">
                <div className="w-full md:w-2/3 flex flex-col items-center text-center space-y-5">
                    <div>
